...
interface CliConfig {
  ...
  /** 自定义端点使用的模型名 */
  aiModel: string
  /** 助手白名单 (@im.wechat ID, 逗号/空格分隔); 空 = 允许所有人 */
